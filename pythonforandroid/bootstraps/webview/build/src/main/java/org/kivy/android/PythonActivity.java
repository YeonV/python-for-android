...
public class PythonActivity extends Activity {
        ...
        protected void onPostExecute(String result) {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onPermissionRequest(final PermissionRequest request) {
                    ...
                    PythonActivity.mActivity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            boolean allAppPermissionsSufficient = true;
                ...
                public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                    ...
                    PythonActivity.this.mFileUploadCallbackInstance = filePathCallback;
            ...
            try {
                ...
                if (mMetaData != null && mMetaData.containsKey("wakelock") && mMetaData.getInt("wakelock") == 1) {
                    PythonActivity.this.mWakeLock = pm.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK, TAG + ":ScreenOn");
    ...
    public static ImageView mImageView = null;
        ...
        public static void start_service(boolean showForegroundNotification, String serviceTitle, String serviceDescription, String pythonServiceArgument) {
            if (PythonActivity.mActivity == null) {
                Log.e(TAG, "start_service called but mActivity is null.");
                return;
            }
    ...
    /**
     * Used by android.permissions p4a module to register a call back after requesting runtime permissions
     */
